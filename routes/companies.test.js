...
describe("GET /companies", function () {
  ...
  test("ok to get companies by name", async function() {
  ...
  test("ok to get companies by min number", async function () {
  ...
  test("ok to get companies by name and min number", async function() {
  ...
  test("ok to get companies by numbers", async function() {
